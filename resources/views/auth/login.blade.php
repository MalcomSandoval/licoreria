...
<div class="text-center mb-6 sm:mb-8">
    ...
    <p class="text-blue-600 text-xs sm:text-sm tracking-widest font-semibold">Punto de Venta</p>
</div>
...
<div class="bg-gradient-to-b from-white to-blue-50 rounded-2xl shadow-2xl border border-blue-200 p-6 sm:p-8 space-y-6">
    <!-- Error Message -->
    @if(session('error'))
        <div class="bg-red-50 border border-red-300 text-red-700 px-4 py-3 rounded-lg flex items-start gap-3 animate-pulse">
            <span class="text-xl">⚠️</span>
            <p class="text-sm">{{ session('error') }}</p>
        </div>
    @endif

    <h2 class="text-xl sm:text-2xl font-bold text-blue-900 text-center">Iniciar Sesión</h2>
