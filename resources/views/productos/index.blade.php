...
@section('content')
    <div class="space-y-8 animate-fade-in relative">
        ...
        <div class="grid grid-cols-2 lg:grid-cols-6 gap-4 sm:gap-6">
            ...
            <div class="bg-app-card rounded-2xl shadow-lg border border-app-accent/50 p-5 hover:border-amber-500/50 transition-colors group col-span-2 lg:col-span-1 overflow-hidden">
                ...
                <div class="grid grid-cols-[1fr_auto] gap-2 items-start">
                    ...
                    <div class="flex flex-col min-w-0">
                        <p class="text-xl sm:text-2xl font-bold text-white group-hover:text-amber-400 transition-colors leading-none truncate">
                        ...
                        <p class="text-[10px] text-app-textMuted font-mono mt-2 opacity-80 whitespace-nowrap overflow-hidden text-ellipsis">
